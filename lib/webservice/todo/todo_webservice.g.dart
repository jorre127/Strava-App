...
class _TodoWebService implements TodoWebService {
  ...
  Future<List<Todo>> getTodos() async {
    ...
    final _result = await _dio.fetch<List<dynamic>>(_setStreamType<List<Todo>>(Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
        .compose(_dio.options, '/todos', queryParameters: queryParameters, data: _data)
